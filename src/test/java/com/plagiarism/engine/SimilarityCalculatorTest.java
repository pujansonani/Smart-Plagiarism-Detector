...
public class SimilarityCalculatorTest {
    ...
    public void testLCSSimilarityPartial() {
        ...
        double similarity = SimilarityCalculator.calculateLCSSimilarity(str1, str2);
        assertTrue("Partially matching strings should have moderate LCS similarity", similarity > 0.0 && similarity < 1.0);
    }
    ...
    public void testLongestCommonSubsequence() {
        ...
        assertEquals("LCS of 'AGGTAB' and 'GXTXAYB' should be 5", 5, lcsLength);
    }
